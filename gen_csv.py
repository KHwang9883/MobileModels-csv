...
# 匹配设备类型的正则
_re_device_type = re.compile(r'(手机|手表|手环|平板|电视主机|盒子|(智能)?电视|笔记本电脑|设备|穿戴|眼镜|Mobile|Phone|Pad|Pod|Tablet|Watch|Band|WATCH|Device|Glass|Eyewear|\bTV\b|学习智慧屏|智慧屏|Buds|Headphone|Book)')
_device_map = dict(
    手机='mob',
    mobile='mob',
    phone='mob',
