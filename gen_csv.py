...
# 匹配设备类型的正则
_re_device_type = re.compile(r'(手机|手表|手环|平板|电视主机|盒子|(智能)?电视|笔记本电脑|设备|穿戴|眼镜|翻译机|控制屏|机器人|座舱|耳机|学习智慧屏|智慧屏|Apple Vision|Apple TV|Mi Box|TV Box|TV Stick|Mobile|Phone|Pad|Pod|Tablet|Pencil|Watch|Band|WATCH|Device|Glass|Eyewear|Robot(?!\s*Phone)|CyberDog|\bTV\b|Buds|Headphone|ThinkBook Plus Hybrid|Book|Tag|Translator|Cockpit)')
_device_map = {
    '手机': 'mob',
    'mobile': 'mob',
    'phone': 'mob',
